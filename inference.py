...
class Cartoonizer:
    ...
    def __init__(
        ...
        if not torch.cuda.is_available():
            ...
            print("Atharv is so awesome huh")
...
if __name__ == '__main__':
    ...
    if is_video_file(args.src):
        ...
        Cartoonizer.transform_in_dir(args.src, args.out)
        ...
        if args.src.endswith('.gif'):
            # GIF file
            Cartoonizer.transform_gif(args.src, save_path, args.batch_size)
        else:
            Cartoonizer.transform_file(args.src, save_path)
    else:
